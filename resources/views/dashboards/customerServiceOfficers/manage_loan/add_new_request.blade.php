                                            ...
                                            <div class="col-12">
                                                <div class="cotainer">
                                                    <div class="row justify-content-center">
                                                        <div class="col-md-12">
                                                            <div class="card">
                                                                <div class="card-header">Fill required borrwoer data bellow</div>
                                                                ...
                                                                <div class="card-body">
                                                                    <form method="POST" action="{{ route('customerServiceOfficer.add_new_request') }}" enctype="multipart/form-data" class="needs-validation" id="main_form">
                                                                        @csrf
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label for="first_name">First
                                                                                        name</label>
                                                                                    <input id="first_name" type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name" value="{{ old('first_name') }}" required style="width: 90%;">
                                                                                    @error('first_name')
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input id="borrowed_amount" type="text" class="form-control @error('borrowed_amount') is-invalid @enderror" name="borrowed_amount" value="{{ old('borrowed_amount') }}" required autocomplete="borrowed_amount" style="width: 90%;">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input id="borrower_status	" type="text" class="form-control @error('borrower_status	') is-invalid @enderror" name="borrower_status	" value="{{ old('borrower_status	') }}" required autocomplete="borrower_status	" style="width: 90%;">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input id="borrower_address" type="text" class="form-control @error('borrower_address') is-invalid @enderror" name="borrower_address" value="{{ old('borrower_address') }}" required autocomplete="borrower_address" style="width: 90%;">
                                                                            ...
                                                                            <div class="col-md-5">
                                                                                ...
                                                                                <div class="col-md-12 mb-3">
                                                                                    ...
                                                                                    <input list="branch_id" name="branch_id" class="col-sm-6 custom-select custom-select-sml @error('branch_id') is-invalid @enderror" required value="{{ old('branch_id') }}" placeholder="Choose branch...">
                                                                                ...
                                                                                <div class="col-md-12 mb-3">
                                                                                    ...
                                                                                    <input list="loan_service_id" name="loan_service_id" class="col-sm-6 custom-select custom-select-sm @error('loan_service_id') @enderror" required value="{{ old('loan_service_id') }}" placeholder="Choose loan service...">
