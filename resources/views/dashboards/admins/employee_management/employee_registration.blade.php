                                                    ...
                                                    <div class="row justify-content-center">
                                                        <div class="col-md-8">
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    <form method="POST" action="{{ route('admin.employee_registration') }}" enctype="multipart/form-data" id="employee_registration_form">
                                                                        ...
                                                                        <div class="card-body">
                                                                            ...
                                                                            <div class="col-md-12 mb-3">
                                                                                ...
                                                                                <input list="branch_id" name="branch_id" class="col-sm-6 custom-select custom-select-sm" required="" placeholder="Choose role...">
                                                                            ...
                                                                            <div class="col-md-12 mb-3">
                                                                                <label for="role_id">Employee
                                                                                    role</label><br>
                                                                                <input list="role_id" name="role_id" class="col-sm-6 custom-select custom-select-sm" required="" placeholder="Choose role...">
                                                                                <datalist id="role_id">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label for="employee_photo">Choose
                                                                                    photo</label>
                                                                                <input type="file" class="form-control" name="employee_photo" id="employee_photo" style="width: 50%; height: 50%;" required>
                                                                            </div>
                                                                            <div class="invalid-feedback">
                                                                                Choose valid photo.
                                                                            </div>
