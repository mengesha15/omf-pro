                                                    ...
                                                    <div class="row justify-content-center">
                                                        <div class="col-md-8">
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    <form method="POST" action="{{ route('admin.employee_registration') }}" enctype="multipart/form-data" class="needs-validation" novalidate>
                                                                        @csrf
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="phone_number">Phone
                                                                                number</label>
                                                                            <input id="phone_number" type="text" class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" value="{{ old('phone_number') }}" required autocomplete="phone_number" style="width: 90%;">
                                                                            @error('phone_number')
                                                                            <span class="invalid-feedback" role="alert">
                                                                                <strong>{{ $message }}</strong>
                                                                            </span>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="birth_date">Birth
                                                                                date</label>
                                                                            <input id="birth_date" type="date" class="form-control @error('birth_date') is-invalid @enderror" name="birth_date" value="{{ old('birth_date') }}" required autocomplete="birth_date" style="width: 90%;">
                                                                            @error('birth_date')
                                                                            <span class="invalid-feedback" role="alert">
                                                                                <strong>{{ $message }}</strong>
                                                                            </span>
                                                                        ...
                                                                        <div class="col-md-12 mb-3">
                                                                            ...
                                                                            <input list="branch_id" name="branch_id" class="form-control @error('birth_date') is-invalid @enderror" required value="{{ old('branch_id') }}" placeholder="Choose role...">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="role_id">Employee
                                                                                role</label><br>
                                                                            <input list="role_id" name="role_id" class="form-control @error('birth_date') is-invalid @enderror" required value="{{ old('role_id') }}" placeholder="Choose role...">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="employee_photo">Choose
                                                                                photo</label>
                                                                            <input type="file" class="form-control @error('employee_photo') is-invalid @enderror" name="employee_photo" id="employee_photo" value="{{ old('employee_photo') }}" style="width: 50%; height: 50%;" required>
