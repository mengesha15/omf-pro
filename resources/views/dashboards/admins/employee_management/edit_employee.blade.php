                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input list="branch_id" name="branch_id" value="{{ $employee->branch_id }}" class="col-sm-6 custom-select custom-select-sm @error('branch_id') is-invalid @enderror" required placeholder="Choose role...">  <datalist id="branch_id">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <label for="role_id">Employee
                                                        role</label><br>
                                                    <input list="role_id" name="role_id" class="col-sm-6 custom-select custom-select-sm @error('role_id') is-invalid @enderror" required value="{{ $employee->role_id }}" placeholder="Choose role...">
