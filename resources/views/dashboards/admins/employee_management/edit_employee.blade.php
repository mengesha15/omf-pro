                                                                    ...
                                                                    <form method="POST" action="{{ url('admin/edit_employee/'.$employee->id) }}" enctype="multipart/form-data" class="needs-validation" novalidate>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="birth_date">Birth
                                                                                date</label>
                                                                            <input value="{{ $employee->birth_date }}" id="birth_date" type="date" class="form-control @error('birth_date') is-invalid @enderror" name="birth_date" required autocomplete="birth_date" style="width: 90%;">
                                                                        ...
                                                                        <div class="col-md-12 mb-3">
                                                                            ...
                                                                            <input list="branch_id" name="branch_id" value="{{ $employee->branch_id }}" class="form-control @error('branch_id') is-invalid @enderror" required placeholder="Choose role...">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="role_id">Employee
                                                                                role</label><br>
                                                                            <input list="role_id" name="role_id" class="form-control @error('role_id') is-invalid @enderror" required value="{{ $employee->role_id }}" placeholder="Choose role...">
                                                                            <datalist id="role_id">
                                                                        ...
                                                                        @else
                                                                         <div class="form-group">
                                                                             <div class="form-check">
                                                                                 <input class="form-check-input" value="Female" type="radio" name="employee_gender"  id="female">
                                                                                 <label class="form-check-label" for="female">Female</label>
                                                                             </div>
                                                                             <div class="form-check">
                                                                                 <input checked class="form-check-input" type="radio" name="employee_gender" value="Male" id="male">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="employee_photo">Choose
                                                                                photo</label>
                                                                            <input value="{{ $employee->employee_photo }}" type="file" class="form-control @error('employee_photo') is-invalid @enderror" name="employee_photo" id="employee_photo" style="width: 50%; height: 50%;" required>
