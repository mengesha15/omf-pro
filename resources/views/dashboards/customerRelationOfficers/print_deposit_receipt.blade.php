{{-- <div class="wrap">
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#print_deposit_receipt">
    </button>
</div>
<div id="printThis">
    <div id="print_deposit_receipt" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">

        <div class="modal-header">
            <h4 class="modal-title">Deposit receipt</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              ...
              <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button class="btn" data-dismiss="modal" aria-hidden="true" id="close-print">Close</button>
                    <button id="btnPrint" type="button" class="btn btn-default" id="print-receipt">Print</button>
                </div>
            </div>
        </div>
    </div>
